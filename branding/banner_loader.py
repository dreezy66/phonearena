...
def load_banners(base_dir: str):
    """Load banner definitions from JSON file in branding/."""
...
def get_banner_text(banners: dict, mode: str = "adaad") -> str:
    """Pick banner by mode; default to 'adaad' if missing."""
...
def print_banner(base_dir: str, mode: str = "adaad", stream=None):
    """Print the ASCII art banner for a given mode."""
